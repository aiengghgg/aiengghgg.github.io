...
import DefaultNavbarDropdown from "layouts/Navbar/DefaultNavbarDropdown";
import DefaultNavbarMobile from "layouts/Navbar/DefaultNavbarMobile";
import breakpoints from "assets/theme/base/breakpoints";

function Navbar({ routes, transparent, light, action, sticky, relative, center }) {
